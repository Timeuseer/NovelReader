...
class login_flose(wx.Frame):

    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"登录失败", pos=wx.DefaultPosition, size=wx.Size(279, 109),
        ...
        self.m_staticText13 = wx.StaticText(self, wx.ID_ANY, u"您输入的密码错误，请重新输入！", wx.DefaultPosition, wx.DefaultSize, 0)
